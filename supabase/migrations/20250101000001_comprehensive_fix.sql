-- Comprehensive fix for all relationship and RLS policy issues
-- This migration addresses all the 400 and 403 errors that have resurfaced
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE clubs ADD COLUMN created_by UUID REFERENCES auth.users(id) ON DELETE SET NULL;
    END IF;
END $$;
